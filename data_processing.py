...
def process_physionet(subject, name, task, verbose=False, visualise=False):
    """
    ...
    # Save Epochs
    epochs.save(DATA_DIR + '/physionet-fifs/' + name + '-epo.fif', overwrite=True)
...
if __name__ == "__main__":
    ...
    # process_physionet(3, "S3-MI-FF")#, verbose=True, visualise=True)

    # for i in range(1, 25):
    #     process_physionet(i, "/task2/s" + str(i), 2)
